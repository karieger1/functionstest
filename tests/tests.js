...
describe("max", function() {
	...
	it("should return five if I pass in two integers, 5 & 4", function() {
		expect(max(5, 4)).to.equal(5);
	});
	it("should return one if I pass in zero and one", function() {
	expect(max(0, 1)).to.equal(1);
	});
	it("should throw an error if input includes empty string", function() {
	expect (function() { max("", 3);}).to.throw("Invalid Input");
	});
});
...
describe("isVowel", function() {
	...
	it("should return true if letter is a", function() {
		expect(isVowel("a")).to.equal(true);
	});
	it("should return false if letter is t", function() {
	expect(isVowel("t")).to.equal(false);
	});
	it("should throw an error if input is not a string", function() {
	expect (function() { isVowel(3);}).to.throw("Invalid Input");
	});
});
...
describe("rovarspraket", function() {
	...
	expect (function() { rovarspraket(3);}).to.throw("Invalid Input");
	});
...
describe("multiply", function() {
	...
	it("should return 24 if I pass in array [1,2,3,4]", function() {
...
describe("charFreq", function() {
	...
	it("should return z1 of each letter except l, which returns 2", function() {
